...
export default function InventoryPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [timeRes, weekendRes] = await Promise.all([
          axios.get("http://localhost:8000/api/inventory/time-pattern"),
          axios.get("http://localhost:8000/api/inventory/weekend-rush")
        ]);
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip 
                ...
                formatter={(value: number) => [value.toLocaleString(), "Unit Terjual"]}
              />
