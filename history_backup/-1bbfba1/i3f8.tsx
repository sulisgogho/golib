...
import { AlertTriangle, BrainCircuit, CheckCircle, TrendingDown, TrendingUp } from 'lucide-react'
...
export default function PredictivePage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [churnRes, forecastRes] = await Promise.all([axios.get('http://localhost:8000/api/predict/churn'), axios.get('http://localhost:8000/api/predict/forecast')])
