...
export default function CustomerPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [loyaltyRes, intervalRes] = await Promise.all([axios.get('/api/analytics/loyalty'), axios.get('h/api/analytics/interval')])
  ...
  return (
    <div className="space-y-8 pb-10">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Customer</h1>
