...
# 5. Endpoint Baru: Analisis Jam Sibuk (Traffic)
@app.get("/api/dashboard/activity")
async def get_activity_analysis(db: AsyncSession = Depends(get_db)):
    # Query: Hitung jumlah order berdasarkan jam (0-23)
    query = text("""
    ...
    return [{"hour": row.order_hour_of_day, "orders": row.total_orders} for row in rows]
