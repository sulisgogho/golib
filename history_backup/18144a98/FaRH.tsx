      ...
      <div className="bg-white p-8 rounded-[24px] shadow-sm w-full max-w-md border border-gray-50">
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            ...
            <input type="text" className="bg-[#F0F2F1] text-gray-800 text-sm rounded-xl block w-full pl-11 p-3.5 focus:outline-none focus:ring-2 focus:ring-[#0B4D3C] transition-all" placeholder="username_anda" />
          </div>
        </div>
