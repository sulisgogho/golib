        ...
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={loyaltyData}>
              ...
              <YAxis />
              <Tooltip labelFormatter={(label) => `Order ke-${label}`} formatter={(value: number) => [value.toLocaleString(), 'User Bertahan']} />
        ...
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={intervalData}>
              ...
              <XAxis dataKey="days" />
              <YAxis />
              <Tooltip labelFormatter={(label) => `${label} Hari Jeda`} formatter={(value: number) => [value.toLocaleString(), 'Transaksi']} cursor={{ fill: 'transparent' }} />
