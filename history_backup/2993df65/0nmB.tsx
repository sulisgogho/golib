          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="flex bg-gray-100 p-1 rounded-xl">
                {/* Sembunyikan pilihan pembayar jika Single, tapi tetap kirim datanya sebagai User Utama */}
{account.partner_1_name ? (
  <div className="flex gap-2">
     <button type="button" onClick={() => setPaidBy("Tyo")}>Tyo</button>
     <button type="button" onClick={() => setPaidBy("El")}>El</button>
  </div>
) : (
