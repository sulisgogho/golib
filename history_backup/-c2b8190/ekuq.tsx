...
export default function DashboardPage() {
  return (
    <div className="min-h-screen bg-[#F7F9F8] pb-24 font-sans max-w-md mx-auto relative shadow-xl overflow-hidden">
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white rounded-t-[30px] flex justify-between items-center px-12 pt-4 pb-6 shadow-[0_-5px_20px_rgba(0,0,0,0.05)] z-50">
        {/* Tombol Beranda */}
        ...
        {/* Tombol Tambah Tengah (Floating dengan ilusi Cutout) */}
        <div className="absolute left-1/2 -translate-x-1/2 -top-6">
          <Link href="/tambah" className="w-16 h-16 bg-[#0B4D3C] rounded-full flex items-center justify-center text-white shadow-[0_8px_16px_rgba(11,77,60,0.3)] border-[6px] border-[#F7F9F8] hover:scale-105 transition-transform">
