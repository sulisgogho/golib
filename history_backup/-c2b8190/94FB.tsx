...
export default function DashboardPage() {
  return (
    <div className="min-h-screen bg-[#F7F9F8] pb-24 font-sans max-w-md mx-auto relative shadow-xl overflow-hidden">
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-100 flex justify-between items-center px-12 pt-4 pb-6 z-50">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -top-6">
          <Link href="/tambah" className="w-16 h-16 bg-[#0B4D3C] rounded-full flex items-center justify-center text-white shadow-[0_8px_16px_rgba(11,77,60,0.2)] border-[6px] border-white hover:scale-105 transition-transform">
