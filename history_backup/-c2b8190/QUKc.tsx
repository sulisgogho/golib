...
export default function DashboardPage() {
  return (
    <div className="min-h-screen bg-[#F7F9F8] pb-24 font-sans max-w-md mx-auto relative shadow-xl overflow-hidden">
      ...
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-200 flex justify-between items-center px-10 py-3 z-50">
        {/* Tombol Beranda */}
