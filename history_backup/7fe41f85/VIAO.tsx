    ...
    const fetchData = async () => {
      try {
        const [deptRes, prodRes, mbaRes] = await Promise.all([
          axios.get('http://localhost:8000/api/analytics/departments'),
          axios.get('http://localhost:8000/api/analytics/top-products'),
          axios.get('http://localhost:8000/api/analytics/mba'), // Fetch data MBA
        ])
