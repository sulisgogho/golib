...
export default function Sidebar() {
  ...
  return (
    <>
      {/* ── Desktop Sidebar ── */}
      <aside className="hidden lg:flex flex-col items-center w-[80px] h-full shrink-0 bg-surface-200 dark:bg-surface-950 border-r border-surface-300 dark:border-surface-800 z-20 py-8">
        {/* Logo */}
        ...
        <div className="mt-auto flex flex-col gap-4 items-center w-full">
          ...
          <button className="flex items-center justify-center w-10 h-10 rounded-full text-surface-600 dark:text-surface-400 hover:text-surface-900 dark:hover:text-white transition-colors">
